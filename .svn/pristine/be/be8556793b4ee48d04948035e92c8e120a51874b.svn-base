...
<script type="text/javascript"
        src="${zl.admin.resource.address}/js/ueditor/ueditor.config.js?version=${zl.admin.resource.version}"></script>
<script type="text/javascript"
        src="${zl.admin.resource.address}/js/ueditor/ueditor.all.min.js?version=${zl.admin.resource.version}"></script>
<script type="text/javascript"
        src="${zl.admin.resource.address}/js/ueditor/lang/zh-cn/zh-cn.js?version=${zl.admin.resource.version}"></script>
