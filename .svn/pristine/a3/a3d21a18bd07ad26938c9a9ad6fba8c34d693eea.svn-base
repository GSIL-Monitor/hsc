...
public class HttpClientUtil {
     ...
     */
    public static String send(String url, Map<String, Object> params) throws KeyManagementException, NoSuchAlgorithmException, ClientProtocolException, IOException, KeyStoreException {
        String body = "";
