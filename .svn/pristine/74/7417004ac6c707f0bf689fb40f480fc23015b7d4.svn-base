...
<div class="page-wrapper">
    ...
    <div class="w100p menuContent oh mb24">
        <div class="menu m0a" id="cutMenu">
            <ul>
                <li class="current" onclick="cutMenu(this,1)"><a>新手指导</a></li>
                <li onclick="cutMenu(this,2)"><a>问题汇总</a></li>
                <li onclick="cutMenu(this,3)"><a>联系我们</a></li>
            </ul>
        </div>
    </div>
    <div class="page-content-wrapper">
        <input type="hidden" name="helptype" id="helptype" value="1"/>
        <input type="hidden" name="searchhelptype" id="searchhelptype" value="1"/>
        ...
        <div class="contentwrap m0a" id="problem">
            <div class="left fl mb100">
                <div class="catlist">
                    <div class="catMenu pr" id="removeNewGuidanceCurrent">
                    ...
                    <div class="catMenu pr" id="removeProblemSummaryCurrent" style="display: none">
                    <#if problemSummaryLevel1ModelList?? >
                        <#list problemSummaryLevel1ModelList as level1List>
                            <div class="catTitle bgcfa"
                                 value="nps${level1List_index}">${level1List.levelmodulename!''}</div>
                            <#if level1List_index==0>
                            <ul class="" id="dnps${level1List_index}">
                            <#else>
                            <ul class="dn" id="dnps${level1List_index}">
                            </#if>
                            <#if level1List.level2ModelList?? >
                                <#list level1List.level2ModelList as level2List>
                                    <li class=""
        ...
        <div class="contentwrap m0a" id="searchContact" style="display: none">
            ...
            <div class="searchCate mb15">
                <ul>
                    <li class="current" onclick="cutSearchMenu(this,1)"><a id="newGuidanceNum"></a></li>
                    <li onclick="cutSearchMenu(this,2)"><a id="problemSummaryNum"></a></li>
                </ul>
            </div>
...
<script>
   //分页  每页数量
    ...
    //初始化页面数据
    getTitleList(dataList, 1,"initial");
    ...
    //切换 新手指导 二级模块选中
    $("#removeNewGuidanceCurrent.catTitle.bgcfa").click(function () {
    ...
    //切换 问题汇总 二级模块选中
    $("#removeProblemSummaryCurrent.catTitle.bgcfa").click(function () {
        var val = $(this).attr("value");
        var dnid = "dps" + val;
        if ($('#' + dnid).is('.dn')) {
            $('#' + dnid).addClass("dn");
    ...
    function refreshTitleDetail(titleid) {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            $('#titletext').replaceWith(data.detail);
        }
        $('#problem').show();
        $('#searchContact').hide();
        $('#replacehtml').hide();
