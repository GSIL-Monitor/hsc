        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown topbar-notice">
                <a type="button" data-toggle="dropdown">
                    ...
                    <audio id="notifyAudio"><source src="notify.ogg" type="audio/ogg"><source src="${zl.web.resource.address}/images/notify.mp3" type="audio/mpeg"><source src="${zl.web.resource.address}/images/notify.mp3" type="audio/wav"></audio>
                </a>
            ...
            <script type="text/javascript" src="${zl.web.resource.address}/js/message.js?version=${zl.web.resource.version}"></script>
