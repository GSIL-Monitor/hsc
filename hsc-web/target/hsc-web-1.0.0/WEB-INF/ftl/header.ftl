        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown topbar-notice">
                <a type="button" data-toggle="dropdown">
                    ...
                    <audio id="notifyAudio"><source src="notify.ogg" type="audio/ogg"><source src="http://091801.zhonglunnet.com/web/images/notify.mp3" type="audio/mpeg"><source src="http://091801.zhonglunnet.com/web/images/notify.mp3" type="audio/wav"></audio>
                </a>
            ...
            <script type="text/javascript" src="http://091801.zhonglunnet.com/web/js/message.js?version=1.0.0"></script>
