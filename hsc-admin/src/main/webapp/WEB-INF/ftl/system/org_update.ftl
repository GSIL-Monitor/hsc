...
<script>
    ...
    function updateOrg() {
        ...
        var url = '${ctxPath}/org/update.action';
        var params = {
            id: orgId,
            ordernum: orderNum,
            pid: parentId,
        ...
        <div class="portlet-body form">
            ...
            <form action="" method="post" class="form-horizontal ajaxfrom" role="form" id="form-user">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="orgName" name="orgName" type="text" class="form-control" value="${org.name!''}"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <textarea id="orgRemark" name="orgRemark" style="height:80px;resize: none;"
                                  class="form-control">${org.remark!''}</textarea>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button type="button" onclick="updateOrg()" class="btn btn-default "><i class="fa fa-save"></i> 保存</button>
