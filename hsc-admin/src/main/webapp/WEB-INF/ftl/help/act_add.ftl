...
<script>
    ...
    function addAct() {
        ...
        var url = '${ctxPath}/help/addnewhelpcenter.action';
        var params = {
            title: title,
...
<form action="#" method="get" class="form-horizontal" role="form" id="searchForm">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <label class="radio-inline">
                            <input type="radio" name="systemplatform" value="1"  onclick="firstSe3(this.value)" checked> 商户后台
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="systemplatform" value="2" onclick="firstSe3(this.value)"> 收银终端
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <label class="radio-inline">
                            <input  id="pro1" type="radio"  name="helptype" value="1"  onclick="firstSe2(this.value)"  checked> 问题汇总
                        </label>
                        <label  id="pro"   class="radio-inline">
                            <input   type="radio" name="helptype" value="2" onclick="firstSe2(this.value)"> 新手指导
                        </label>
                    </div>
                </div>
                                          ...
                                          <#if listformodule2??>
                                              <#list listformodule2 as list2>
                                               <option value="${list2.id}"
                                                <#if (RequestParameters.level2modulename!'') == '${list2.levelmodulename}'>selected</#if>>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="title" name="title" type="text" class="form-control" value="" placeholder="输入50字以内的标题" maxlength="50">
                </div>
            </div>
            <div class="form-body">
                <div class="row">
    ...
    <div class="form-group col-sm-12">
        <input type="button" id="tijiao" value="提交"  name="tijiao" class="btn btn-primary col-lg-1" onclick="addAct()">
