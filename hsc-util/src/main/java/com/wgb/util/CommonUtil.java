...
public class CommonUtil {
    ...
    public static String getRequestUrl(HttpServletRequest request) {
        ...
        return new StringBuilder("").append(request.getScheme()).append("://").append(request.getServerName()).append(portString).append(request.getRequestURI()).toString();
    }
    ...
    public static String getRequestUrl(HttpServletRequest request, String uri) {
        ...
        return new StringBuilder("").append(request.getScheme()).append("://").append(request.getServerName()).append(portString).append(uri).toString();
    }
